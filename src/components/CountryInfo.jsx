...
export function CountryInfo() {
  ...
  return (
    <div className="grid lg:grid-cols-2 grid-cols-1 items-center justify-center gap-20">
    ...
    <div className="gap-8 flex flex-col justify-center ">
      ...
      <div className="grid grid-cols-1 md:grid-cols-2">
        ...
        <p className="flex flex-col dark:text-white gap-2">
          ...
          <span className="font-semibold">Languages: <span className="font-light">{context.infoCountry.languages[0].name}</span></span>
        </p>
      </div>
          ...
          <p className="flex flex-col md:flex-row gap-2">

            {
              context.infoCountry.borders?.map(border =>  (
                <span className="font-medium w-full flex dark:text-white justify-center p-2 bg-white dark:shadow-md dark:shadow-slate-800 dark:bg-dark-blue-elements-dark shadow-gray-200 shadow-lg rounded-md">{border}</span>
              ))
            }
          </p>
        </div>
